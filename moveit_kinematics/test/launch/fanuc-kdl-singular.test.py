    ...
    singular_unit_tests_poses = {
        "unit_test_poses": {
            ...
            "pose_1": {
                ...
                # 'type':   'relative'
                # ! Changed ground truth
                "pose": [0.990000, 0, 1.250000, 0.707107, -0.000000, 0.707107, 0],
                "joints": [
                    0.0,
                    0.17225521580111153,
                    0.18616019238929934,
            ...
            "pose_5": {
                ...
                #   'type':   'relative'
                # ! Changed ground truth
                "pose": [0.890000, 0, 1.350000, 0.707107, -0.000000, 0.707107, 0],
                "joints": [
                    0.0,
            ...
            "pose_6": {
                ...
                # 'type':   'relative'
                # ! Changed ground truth
                "pose": [0.890000, 0, 1.150000, 0.707107, -0.000000, 0.707107, 0],
                "joints": [
                    0.0,
            ...
            "pose_9": {
                ...
                # 'type':   'relative'
                # ! Changed ground truth
                "pose": [0.890000, 0, 1.250000, 0.741596, 0, 0.6708468, 0],
                "joints": [
                    0,
            ...
            "pose_10": {
                ...
                # 'type':   'relative'
                # ! Changed ground truth
                "pose": [0.890000, 0, 1.250000, 0.6709182, 0, 0.7415314, 0],
                "joints": [
                    0.0,
