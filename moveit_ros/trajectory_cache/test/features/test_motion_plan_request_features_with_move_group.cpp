...
TEST_F(MoveGroupFixture, MotionPlanRequestRoundTrip)
{
  ...
  std::vector<std::unique_ptr<FeaturesInterface<moveit_msgs::msg::MotionPlanRequest>>> features_under_test;
  ...
  moveit_msgs::msg::MotionPlanRequest msg;
  move_group_->constructMotionPlanRequest(msg);

  // Core test.
  for (auto& feature : features_under_test)
  {
    MessageCollection<moveit_msgs::msg::MotionPlanRequest> coll =
        db_->openCollection<moveit_msgs::msg::MotionPlanRequest>("test_db", feature->getName());
