...
{
  // Setup.
  BestSeenExecutionTimePolicy policy;
...
TEST_F(MoveGroupFixture, BestSeenExecutionTimePolicyWorks)
{
  BestSeenExecutionTimePolicy policy;
  ...
  std::vector<std::unique_ptr<FeaturesInterface<MotionPlanRequest>>> features =
      BestSeenExecutionTimePolicy::getSupportedFeatures(/*start_tolerance=*/0.025, /*goal_tolerance=*/0.001);
