...
void MoveGroupMultiStateValidationService::initialize() {
  validity_service_ =
      context_->moveit_cpp_->getNode()
          ->create_service<moveit_msgs::srv::GetMultiStateValidity>(
              MULTI_STATE_VALIDITY_SERVICE_NAME,
              [this](
                  const std::shared_ptr<rmw_request_id_t> &request_header,
                  const std::shared_ptr<
                      moveit_msgs::srv::GetMultiStateValidity::Request> &req,
                  const std::shared_ptr<
                      moveit_msgs::srv::GetMultiStateValidity::Response> &res) {
...
bool MoveGroupMultiStateValidationService::computeService(
    ...
    const std::shared_ptr<moveit_msgs::srv::GetMultiStateValidity::Request>
        &req,
    const std::shared_ptr<moveit_msgs::srv::GetMultiStateValidity::Response>
        &res) {
...
PLUGINLIB_EXPORT_CLASS(move_group::MoveGroupMultiStateValidationService,
