...
class MoveItPy:
    ...
    def execute(self, robot_trajectory: RobotTrajectory, controllers: List[str]) -> None: 
        """
    ...
    def get_planning_component(self, planning_component_name: str) -> 'MoveItPy.PlanningComponent': 
        """
    ...
    class PlanningComponent:
        ...
        def __init__(self, joint_model_group_name: str, moveit_py_instance: 'MoveItPy') -> None: 
            """
        ...
        def plan(
            self,
            single_plan_parameters: Optional[MoveItPy.PlanningComponent.PlanRequestParameters] = None,
            multi_plan_parameters: Optional[MoveItPy.PlanningComponent.MultiPipelinePlanRequestParameters] = None,
        ...
        def set_path_constraints(self, path_constraints: moveit_msgs.msg.Constraints) -> None: 
            """
        ...
        class MultiPipelinePlanRequestParameters:
            ...
            @property
            def multi_plan_request_parameters(self)-> List[MoveItPy.PlanningComponent.PlanRequestParameters] : ...
    ...
    class PlanningSceneMonitor:
        ...
        def new_planning_scene_message(self,
                secen: moveit_msgs.msg.PlanningScene)-> None:
            """
        ...
        def process_attached_collision_object(self,
                attached_collision_objet_msg: moveit_msgs.msg.AttachedCollisionObject)-> None:
            """
        ...
        def process_collision_object(self,
                collision_object_msg: moveit_msgs.msg.CollisionObject,
                color_msg: moveit_msgs.msg.ObjectColor)-> None:
            """
        ...
        def request_planning_scene_state(self,
        ...
        class LockedPlanningSceneContextManagerRO(ContextManager):
            ...
            def __exit__(self, type: Optional[Any], value: Optional[Any], traceback: Optional[Any]) -> None:
                """
    ...
    class TrajectoryExecutionManager:
        ...
        def push(self, 
                trajectory: Union[moveit_msgs.msg.RobotTrajectory, trajectory_msgs.msg.JointTrajectory],
                controller: str) -> None:
            """
        ...
        def stop_execution(self, auto_clear :bool = True) -> None:
            ...
            Args:
                auto_clear: Whether to automatically clear the trajectory queue after stoping execution. Defaults to True.
            """
            ...
