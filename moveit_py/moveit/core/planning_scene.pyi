...
from moveit.core import robot_model, robot_state, robot_trajectory, collision_detection, transforms
...
class PlanningScene:
    ...
    def knows_frame_transform(self, robot_state:robot_state.RobotState, frame_id: str) -> bool:
        """
