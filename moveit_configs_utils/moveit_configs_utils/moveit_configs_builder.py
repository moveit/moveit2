...
Example:
    ...
    # Or
    moveit_configs = MoveItConfigsBuilder("robot_name")
                    # Absolute path to robot_name_moveit_configs
...
class MoveItConfigsBuilder(ParameterBuilder):
    ...
    # Relative path of the SRDF file  w.r.t. robot_name_moveit_configs
    ...
    def robot_description(self, file_path: Optional[str] = None, mappings: dict = None):
        ...
        :param file_path: Absolute or relative path to the URDF file (w.r.t. robot_name_moveit_configs).
    ...
    def robot_description_semantic(
        ...
        :param file_path: Absolute or relative path to the SRDF file (w.r.t. robot_name_moveit_configs).
        :param mappings: mappings to be passed when loading the xacro file.
    ...
    def robot_description_kinematics(self, file_path: Optional[str] = None):
        ...
        :param file_path: Absolute or relative path to the kinematics yaml file (w.r.t. robot_name_moveit_configs).
    ...
    def joint_limits(self, file_path: Optional[str] = None):
        ...
        :param file_path: Absolute or relative path to the joint limits yaml file (w.r.t. robot_name_moveit_configs).
    ...
    def moveit_cpp(self, file_path: Optional[str] = None):
        ...
        :param file_path: Absolute or relative path to the MoveItCpp yaml file (w.r.t. robot_name_moveit_configs).
    ...
    def trajectory_execution(
        ...
        :param file_path: Absolute or relative path to the controllers yaml file (w.r.t. robot_name_moveit_configs).
    ...
    def cartesian_limits(self, file_path: Optional[str] = None):
        ...
        :param file_path: Absolute or relative path to the cartesian limits file (w.r.t. robot_name_moveit_configs).
    ...
    def to_moveit_configs(self):
        """Get MoveIt configs from robot_name_moveit_configs.
    ...
    def to_dict(self, include_moveit_configs: bool = True):
        """Get loaded parameters from robot_name_moveit_configs as a dictionary.
